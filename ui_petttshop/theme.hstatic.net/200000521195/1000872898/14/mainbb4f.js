...
function getContentTab(url,selector){
	...
	var loadding = '<div class="a-center a-center-loading"><img src="//theme.hstatic.net/200000521195/1000872898/14/rolling.svg?v=257"</div>'
	$.ajax({
		type: 'GET',
		url: url,
		beforeSend: function() {
...
$(document).ready(function(){
	...
	if (img_array.length == 1) {
		...
		$('.img_bg_product .bg1').attr("style" , "background-image:url(//theme.hstatic.net/200000521195/1000872898/14/bg_default_pro_1.jpg?v=257)");
		$('.img_bg_product .bg2').attr("style" , "background-image:url(//theme.hstatic.net/200000521195/1000872898/14/bg_default_pro_2.jpg?v=257)");
	}
